...
rhino_list = rhino_str.split(" ")
for word in rhino_list:
...
one_line_str_vowel_count = count_vowels(one_line_str.lower())
print(f"one_line_str_vowel_count = {one_line_str_vowel_count}")

multi_line_str_vowel_count = count_vowels(multi_line_str.lower())
